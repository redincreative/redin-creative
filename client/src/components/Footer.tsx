      ...
      <div className="container">
        ...
        <div className="pt-8 border-t border-border/30 mb-6">
          <div className="flex justify-center gap-4 mb-6">
            <a href="https://www.instagram.com/redincreative" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-accent/50 flex items-center justify-center text-muted-foreground hover:text-gold hover:bg-gold/10 transition-all duration-200 hover:scale-110" aria-label="Instagram">
