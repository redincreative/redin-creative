      ...
      <div className="container">
        ...
        <div className="pt-8 border-t border-border/30 mb-6">
          <div className="flex justify-center gap-4 mb-6">
            ...
            <a href="https://www.xiaohongshu.com/user/redincreative" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-accent/50 flex items-center justify-center text-muted-foreground hover:text-gold hover:bg-gold/10 transition-all duration-200 hover:scale-110" aria-label="小紅書">
              <svg width="18" height="18" viewBox="0 0 200 200" fill="currentColor"><path d="M100 0C44.8 0 0 44.8 0 100s44.8 100 100 100 100-44.8 100-100S155.2 0 100 0zm2.3 45.7h12.5c1.2 0 2.2.7 2.6 1.8l4.5 12.3h15.8c1.5 0 2.7 1.2 2.7 2.7v3.2c0 1.5-1.2 2.7-2.7 2.7h-11.3l8.5 23.3c.4 1.2-.2 2.5-1.4 2.9-.3.1-.6.2-.9.2h-5.8c-1.1 0-2.1-.7-2.5-1.7l-7.8-21.4-7.8 21.4c-.4 1.1-1.4 1.7-2.5 1.7h-5.8c-1.3 0-2.4-1.1-2.4-2.4 0-.3.1-.6.2-.9l8.5-23.3H95.4c-1.5 0-2.7-1.2-2.7-2.7v-3.2c0-1.5 1.2-2.7 2.7-2.7h15.8l4.5-12.3c.4-1.1 1.4-1.8 2.6-1.8zM62.5 78.8h12c1.5 0 2.7 1.2 2.7 2.7v53.8c0 1.5-1.2 2.7-2.7 2.7h-12c-1.5 0-2.7-1.2-2.7-2.7V81.5c0-1.5 1.2-2.7 2.7-2.7zm60 0h12c1.5 0 2.7 1.2 2.7 2.7v53.8c0 1.5-1.2 2.7-2.7 2.7h-12c-1.5 0-2.7-1.2-2.7-2.7V81.5c0-1.5 1.2-2.7 2.7-2.7zm-30 10h12c1.5 0 2.7 1.2 2.7 2.7v43.8c0 1.5-1.2 2.7-2.7 2.7h-12c-1.5 0-2.7-1.2-2.7-2.7V91.5c0-1.5 1.2-2.7 2.7-2.7z"/></svg>
            </a>
